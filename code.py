...
while endGame != "quit":
    ...
    if r.status_code != 200:
       endGame = input(print("Sorry there was a problem retrieving the question. Press enter to try again, or type 'quit' to quit the game"))
    else:
        valid_answer = False
        answer_number = 1
        ...
        if user_answer == correct_answer:
            print("\nCongratulation! You answered correctly! The correct answer was : " + html.unescape(correct_answer))
            score_correct += 1
        else:
            print("Sorry, " + html.unescape(user_answer) + " is incorrect. Thr correct answer is: " + html.unescape(correct_answer))
            score_incorrect += 1
        print("\n##################################")
        print("Your score is :")
